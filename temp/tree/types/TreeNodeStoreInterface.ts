...
export interface TreeStoreInterface<TNode, TRoot extends TNode> {
  /**
   ...
   * @param node - Node
   */
  getNodeIndex(node: TNode): number;
   ...
   * @param rootNode - Root node
   */
  setRootNode<T extends TNode>(node: T, rootNode: TRoot): T;
}
