...
import { div, pow, mul, neg, sub, operand, add, math } from "../../@fixtures";
...
describe(PostfixSerializer.name, () => {
  const serializer = new PostfixSerializer(new MathCreator(math()));
  ...
  describe(`#${serializer.serialize.name}(entity)`, () => {
    ...
    it("should serialize unary unary-operations", () => {
      expect(serializer.serialize(neg(1))).toEqual([[1], EntityType.Neg]);
    });

    it("should serialize binary-operation unary-operations", () => {
    ...
    it("should serialize nested unary-operations", () => {
  ...
  describe(`#${serializer.deserialize.name}(data)`, () => {
    ...
    it("should deserialize unary unary-operations", () => {
      expect(serializer.deserialize(serializer.serialize(neg(1)))).toEqual(
        neg(1),
      );
    });

    it("should deserialize binary-operation unary-operations", () => {
    ...
    it("should deserialize nested unary-operations", () => {
      expect(
