...
/**
 * The {@link FbMetadbHandleList} interface describes a collection.
...
export interface FbMetadbHandleList {
   ...
   * {@link Utils.FormatDuration} on the result.
   */
   ...
   * {@link Utils.FormatFileSize} on the result.
   */
   ...
   * @param direction - Direction. Ascending while \> `0`.
   */
