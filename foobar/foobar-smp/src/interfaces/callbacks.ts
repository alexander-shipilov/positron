...
export interface Callbacks {
   ...
   */
  on_item_focus_change(playlistIndex: number, from: number, to: number): void;
   ...
   */
  on_load_image_done(cookie: number, image: GdiBitmap, imagePath: string): void;
   ...
   */
  on_metadb_changed(handleList: FbMetadbHandleList, fromHook: boolean): void;
   ...
   */
  on_playback_starting(command: PlaybackStartCommand, isPaused: boolean): void;
