 ...
 * and so on.
 *
 * When {@link StringFormatFlags.DirectionVertical} is set and
 * {@link StringFormatFlags.DirectionRightToLeft} is not set, individual lines
 ...
 *
 * When {@link StringFormatFlags.DirectionRightToLeft} is set and
 * {@link StringFormatFlags.DirectionVertical} is not set, the individual lines
