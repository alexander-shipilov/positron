/**
 * The {@link MenuFlag} constant represents menu flags to control the
 * appearance and behavior of the new menu item.
 *
 * @remarks
 * The {@link MenuFlag} constant is used by:
...
export const MenuFlag = {
  ...
  /**
   * Functions the same as the {@link MenuFlag.MenuBreak} flag for a menu bar.
