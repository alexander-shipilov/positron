...
/**
 * The {@link FooBar} interface represents the type of the {@link fb} constant,
 * which is object containing properties and functions for controlling
...
export interface FooBar {
  /**
   * The {@link FooBar.AlwaysOnTop} property represents the `Always on top`
   * state.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.ComponentPath} property represents the
  ...
  /**
   * The {@link FooBar.CursorFollowPlayback} property represents the
   * `Cursor follow playback` state.
   */
  CursorFollowPlayback: boolean;

  /**
   * The {@link FooBar.FoobarPath} property represents foobar path.
   */
  readonly FoobarPath: string;

  /**
   * The {@link FooBar.IsPaused} property specifies if the playback is paused.
   */
  readonly IsPaused: boolean;

  /**
   * The {@link FooBar.IsPaused} property specifies if the playback is started.
   */
  readonly IsPlaying: boolean;

  /**
   * The {@link FooBar.PlaybackFollowCursor} property represents the
   * `Playback follow cursor` state.
   */
  PlaybackFollowCursor: boolean;

  /**
   * The {@link FooBar.PlaybackLength} property represents the current track
   * playback length.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.PlaybackTime} property represents the current track
   * playback time.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.ProfilePath} property represents the current profile
   * path.
   */
  readonly ProfilePath: string;

  /**
   * The {@link FooBar.ReplaygainMode} property represents the current
   * replaygain mode.
   */
  ReplaygainMode: ReplayGainMode;

  /**
   * The {@link FooBar.StopAfterCurrent} property represents the
  ...
  /**
   * The {@link FooBar.Version} property represents the `foobar2000` version.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.Volume} property represents the current volume.
   *
   * @example
   * ```ts
   *  fb.Volume = 0;
  ...
  /**
   * The {@link FooBar.AcquireUiSelectionHolder} method is typically used to
  ...
  /**
   * The {@link FooBar.AddDirectory} method displays a dialog to select playback
   * directory.
   */
  AddDirectory(): void;
  ...
  /**
   * The {@link FooBar.CheckClipboardContents} method checks clipboard contents
   * are handles or a file selection from Windows Explorer. Use in conjunction
   * with {@link FooBar.GetClipboardContents}.
   */
  CheckClipboardContents(): boolean;

  /**
   * The {@link FooBar.ClearPlaylist} method clears active playlist.
  ...
  /**
   * The {@link FooBar.CopyHandleListToClipboard} method copies list items to
  ...
  /**
   * The {@link FooBar.CreateContextMenuManager} method creates menu manager.
   *
   * @remarks
   * todo: See
  ...
  /**
   * The {@link FooBar.CreateHandleList} method creates an empty handle list.
   *
  ...
  /**
   * The {@link FooBar.CreateHandleList} method creates an object to control
   * main menu.
   *
   * @remarks
   * todo: See
  ...
  /**
   * The {@link FooBar.CreateProfiler} method creates a {@link FbProfiler}
   * object.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.DoDragDrop} method invokes drag-n-drop operation.
   *
   * @remarks
   * Quick tips:
   *
   ...
   *
   *  - Drag operation is started with {@link FooBar.DoDragDrop} (whether it is
   *    called by your panel, or externally) with `okEffects` argument
   *    supplied.
   *
   *  - {@link FooBar.DoDragDrop} blocks code execution until the drag
   ...
   *    {@link FooBar.DoDragDrop} call. {@link DropTargetAction.Effect} should
   ...
   *   {@link FooBar.DoDragDrop} might exit before {@link
   *   FbCallbacks.on_drag_drop} callback is triggered when dropping data on
   *   the
   *   same panel as the one that had a call to {@link FooBar.DoDragDrop}.
   *
   * Related callbacks:
  ...
  /**
   * The {@link FooBar.Exit} closes `foobar2000`.
   */
  Exit(): void;

  /**
   * The {@link FooBar.GetClipboardContents} method returns clipboard contents.
   *
   * @remarks
   * Clipboard contents can be handles copied to the clipboard in other
   *   components, from {@link FooBar.CopyHandleListToClipboard} or a file
   *   selection from Windows Explorer etc.
   *
   * Performance note: validate clipboard content with
   *   {@link FooBar.CheckClipboardContents} before calling this method.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.GetDSPPresets} method returns a JSON array in string
  ...
  /**
   * The {@link FooBar.GetFocusItem} method returns the handle of the
  ...
  /**
   * The {@link FooBar.GetLibraryItems} method returns all Media Library items
   * as a handle list.
   */
  GetLibraryItems(): FbMetadbHandleList;

  /**
   * The {@link FooBar.GetLibraryRelativePath} method returns the track path
   * relative to the Media Library. Returns an empty string when used on track
   * not in Media Library.
   *
   * @remarks
   * Note: do not use the {@link FooBar.GetLibraryRelativePath} method while
  ...
  /**
   * The {@link FooBar.GetNowPlaying} method gets handle of now
   * playing item. Returns `null`, if nothing is being played.
   */
  GetNowPlaying(): FbMetadbHandle | null;

  /**
   * The {@link FooBar.GetOutputDevices} method returns a JSON array in string
   * form so you need to use `JSON.parse()` on the result.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.GetQueryItems} method queries items.
   *
   * @remarks
  ...
  /**
   * The {@link FooBar.GetSelection} method gets now playing or selected item.
   *
   * @remarks
  ...
  /**
   * The {@link FooBar.GetSelections} method works like
   * {@link FooBar.GetSelection}, but returns a handle list. Always returns a
  ...
  /**
   * The {@link FooBar.GetSelectionType} method retrieve what the selection is.
   */
  GetSelectionType(): SelectionType;

  /**
   * The {@link FooBar.IsLibraryEnabled} method checks if the media library is
   * enabled.
   */
  IsLibraryEnabled(): boolean;

  /**
   * The {@link FooBar.IsMainMenuCommandChecked} method checks if the specified
   * `command` is checked.
   *
   * @remarks
   * Performance note: don't use {@link FooBar.IsMainMenuCommandChecked} in
  ...
  /**
   * The {@link FooBar.GetSelectionType} method loads playlist from file.
   * Equivalent to `File > Load Playlist...`.
   */
  LoadPlaylist(): void;

  /**
   * The {@link FooBar.Next} method selects next track for the playback.
   */
  Next(): void;

  /**
   * The {@link FooBar.Pause} method pauses the playback.
   */
  Pause(): void;

  /**
   * The {@link FooBar.Play} method starts the playback.
   */
  Play(): void;

  /**
   * The {@link FooBar.PlayOrPause} method toggles playback playing / paused
   * state.
   */
  PlayOrPause(): void;

  /**
   * The {@link FooBar.Prev} method selects prev track for the playback.
   */
  Prev(): void;

  /**
   * The {@link FooBar.Random} method selects random track for the playback.
   */
  Random(): void;

  /**
   * The {@link FooBar.GetSelectionType} method registers a main menu item that
  ...
  /**
   * The {@link FooBar.Restart} method restarts `foobar2000`.
   */
  Restart(): void;

  /**
   * The {@link FooBar.RunContextCommand} method shows context menu for the
  ...
  /**
   * The {@link FooBar.RunContextCommandWithMetadb} method shows context menu
   * for supplied tracks.
   *
   * @param command -
  ...
  /**
   * The {@link FooBar.RunMainMenuCommand} method executes the specified
   * main menu command.
   *
   * @example
   * ```ts
  ...
  /**
   * The {@link FooBar.SavePlaylist} method opens a dialog to save the current
   * playlist.
   */
  SavePlaylist(): void;

  /**
   * The {@link FooBar.SetDSPPreset} method sets the DSP preset.
   *
   * @remarks
  ...
  /**
   * The {@link FooBar.SetOutputDevice} method sets the output device.
   *
   * @remarks
   * Available only in foobar2000 v1.4 and above. Throws a script error on
   * v1.3.
  ...
  /**
   * The {@link FooBar.ShowConsole} method displays the console dialog.
   */
  ShowConsole(): void;

  /**
   * The {@link FooBar.ShowLibrarySearchUI} method displays the
   * `Library > Search` window populated with the query you set.
   */
  ShowLibrarySearchUI(query: string): void;

  /**
   * The {@link FooBar.ShowPopupMessage} method displays the specified
   * `message`.
   *
  ...
  /**
   * The {@link FooBar.ShowPreferences} method displays the preferences window.
   */
  ShowPreferences(): void;

  /**
   * The {@link FooBar.Stop} method stops playback.
   */
  Stop(): void;

  /**
   * The {@link FooBar.TitleFormat} method creates an object to
   * format tracks.
   *
   * @remarks
  ...
  /**
   * The {@link FooBar.UnregisterMainMenuCommand} method unregisters a main
   * menu item.
   *
   * @remarks
   * Related methods:
  ...
  /**
   * The {@link FooBar.VolumeDown} method decreases the current volume level.
   */
  VolumeDown(): void;

  /**
   * The {@link FooBar.VolumeUp} method mutes the volume.
   */
  VolumeMute(): void;

  /**
   * The {@link FooBar.VolumeUp} method increases the current volume level.
   */
  VolumeUp(): void;
}
