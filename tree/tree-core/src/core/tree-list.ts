 ...
 * ```
 */
export interface TreeList<TItem extends TreeItem> extends ArrayLike<TItem> {
  /**
   * The {@link TreeList.forEach} method of the {@link TreeList} interface
  ...
  /**
   * The {@link item} method of the {@link TreeList} interface returns an
   * item from a {@link TreeList} by index. A value of `undefined` is returned
